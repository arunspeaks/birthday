  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To My Piggy🐷</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                My days shine brighter, my smiles grow wider, and everything feels a little more beautiful because of you. 🌸💖
                You’re not just my bestie — you’re my comfort, my laughter, and my forever kind of person. 🫶🐷
                Thank you for being the reason my heart feels warm, even on the coldest days. 💕✨
                </p>
                <p className="text-pink-600 font-medium">Hope your day is full of love, cake, and endless smiles 😊,And don’t forget — I’m the one who makes you smile the most 😋💞✨
</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
